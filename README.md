...
- **Files**:
  ...
  - [Notebook](https://github.com/julianabpeixoto/data-science-portfolio/blob/main/03.SC2023_Module4/jbp_projeto_final_ada_estatistica_I.ipynb)
- **Impact Statement**: The analysis revealed that school shootings are more frequent in cities with populations below 20% of the 2022 median population, highlighting the need for targeted policy interventions. Additionally, exploring gun control legislation showed potential correlations between relaxed laws and increased shooting incidents, suggesting stricter laws may reduce such occurrences. This project underscores the importance of detailed demographic and legislative analysis in formulating effective safety policies.
...
- **Files**:
  - [Detailed Project](https://github.com/julianabpeixoto/neurons-frying/blob/main/04.SC2023_Module5/README.md)
  - [Notebook](https://github.com/julianabpeixoto/data-science-portfolio/blob/main/04.SC2023_Module5/JulianaBertolucciPeixoto_jbp_projeto_final_ada_MachineLearningI.ipynb)
...
- **Files**:
  - [Detailed Project](https://github.com/julianabpeixoto/neurons-frying/blob/main/05.SC2023_Module6/README.md)
  - [Notebook](https://github.com/julianabpeixoto/data-science-portfolio/blob/main/05.SC2023_Module6/jbp_projeto_final_ada_ml_II.ipynb)
